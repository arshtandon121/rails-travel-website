...
ActiveAdmin.setup do |config|
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      menu.add label: 'My Camps', priority: 2, url: -> { admin_camps_path }
      # Add other menu items as needed
    end
  end

  config.current_user_method = :current_user   # Ensure current_user method is defined

  # Define the current_user method for Active Admin
  def current_user
    current_admin_user   # Replace with appropriate method for your current user setup
  end
end



  # Add this method to check for admin role
